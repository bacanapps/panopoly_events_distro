 ...
 */
function panopoly_events_distro_install_tasks(&$install_state) {

  $tasks = array();

  // Add our custom CSS file for the installation process
  drupal_add_css(drupal_get_path('profile', 'panopoly_events_distro') . '/panopoly.css');

  // Add the Panopoly app selection to the installation process
  require_once(drupal_get_path('module', 'apps') . '/apps.profile.inc');
  $tasks = $tasks + apps_profile_install_tasks($install_state, array('machine name' => 'panopoly_events_distro', 'default apps' => array('panopoly_demo')));
 ...
 */
function panopoly_events_distro_install_tasks_alter(&$tasks, $install_state) {
 ...
 */
function panopoly_events_distro_form_install_configure_form_alter(&$form, $form_state) {
 ...
 * Implements hook_form_FORM_ID_alter()
 */
function panopoly_events_distro_form_apps_profile_apps_select_form_alter(&$form, $form_state) {
